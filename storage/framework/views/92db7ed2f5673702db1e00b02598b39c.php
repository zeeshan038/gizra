<?php $__env->startSection('title',translate('Add_new_zone')); ?>
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">
                        <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/zone.png')); ?>" alt="" class="mr-2"> <?php echo e(translate('messages.Add_New_Business_Zone')); ?>
                        ...
                        <div class="col-md-5">
                            <div class="zone-setup-instructions">
                                ...
                                <div class="instructions-image mt-4">
                                    <img src=<?php echo e(dynamicAsset('public/assets/admin/img/instructions.gif')); ?> alt="instructions">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="js-nav-scroller hs-nav-scroller-horizontal">
                                        <ul class="nav nav-tabs mb-4">
                                            <li class="nav-item">
                                                ...
                                                href="#"
                                                id="default-link"><?php echo e(translate('messages.default')); ?> <span class="form-label-secondary text-danger mt-2"
                                                ...
                                                alt="<?php echo e(translate('messages.veg_non_veg')); ?>"></span></a>
                                        ...
                                        <div class="form-group mb-3 " id="">
                                            <div class="row g-3">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="name[]"  class="form-control mb-3" placeholder="<?php echo e(translate('messages.Type_new_zone_name_here')); ?>" maxlength="191" id="default-form-input"  oninvalid="document.getElementById('default-form-input').click()">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="input-label" for="exampleFormControlInput1"><?php echo e(translate('messages.Zone_Display_Name')); ?> (<?php echo e(translate('messages.default')); ?>)</label>
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-sm-6">
                                                        <label class="input-label"
                                                            for="exampleFormControlInput1"><?php echo e(translate('messages.business_Zone_name')); ?> (<?php echo e(strtoupper($lang)); ?>)</label>
                                                        <input id="name" type="text" name="name[]" class="form-control mb-3 h--45px" placeholder="<?php echo e(translate('messages.Type_new_zone_name_here')); ?>" >
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label class="input-label" for="exampleFormControlInput1"><?php echo e(translate('messages.Zone_Display_Name')); ?> (<?php echo e(strtoupper($lang)); ?>)</label>
                                                        <input type="text" name="display_name[]" class="form-control" placeholder="<?php echo e(translate('messages.Write_a_New_Display_Zone_Name')); ?>" maxlength="191"  >
                                                    </div>
                                                </div>
                ...
                <div class="card">
                    <div class="card-header py-2 flex-wrap border-0 align-items-center">
                        <div class="search--button-wrapper">
                            <h5 class="card-title"><?php echo e(translate('messages.zone_list')); ?><span class="badge badge-soft-dark ml-2" id="itemCount"><?php echo e($zones->total()); ?></span></h5>
                            <form class="my-2 mr-sm-2 mr-xl-4 ml-sm-auto flex-grow-1 flex-grow-sm-0">
                                ...
                                <div class="input--group input-group input-group-merge input-group-flush">
                                    <input id="datatableSearch_" type="search" name="search" class="form-control" value="<?php echo e(request()?->search ?? null); ?>"
                                            placeholder="<?php echo e(translate('messages.Search_by_name')); ?>" aria-label="<?php echo e(translate('messages.search')); ?>">
                            ...
                            <div class="hs-unfold ml-3">
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <a target="__blank" id="export-excel" class="dropdown-item" href="<?php echo e(route('admin.zone.export-zones', ['type'=>'excel', request()->getQueryString()])); ?>">
                                    ...
                                    <a target="__blank" id="export-csv" class="dropdown-item" href="<?php echo e(route('admin.zone.export-zones', ['type'=>'csv', request()->getQueryString()])); ?>">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <tr>
                                ...
                                <th class="text-center"><?php echo e(translate('messages.zone_id')); ?></th>
                                <th class="pl-5"><?php echo e(translate('messages.name')); ?></th>
                                <th class="pl-5"><?php echo e(translate('messages.Zone_Display_Name')); ?></th>
                                <th class="text-center"><?php echo e(translate('messages.restaurants')); ?></th>
                                <th class="text-center"><?php echo e(translate('messages.deliverymen')); ?></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm">
                                            <input type="checkbox" class="toggle-switch-input dynamic-checkbox" id="status-<?php echo e($zone['id']); ?>" <?php echo e($zone->status?'checked':''); ?>
                                        ...
                                        <form action="<?php echo e(route('admin.zone.status',[$zone['id'],$zone->status?0:1])); ?>" method="get" id="status-<?php echo e($zone['id']); ?>_form">
                                        </form>
                                    </td>
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            ...
                                            <div class="popover-wrapper hide_data <?php echo e($non_mod == 1 ? 'active':''); ?> ">
                                                ...
                                                <div class="popover __popover  <?php echo e($non_mod == 1  ? '':'d-none'); ?>">
                                                    ...
                                                    <div class="popover-body">
                                                        <?php echo e(translate('The_Business_Zone_will_NOT_work_if_you_don’t_add_the_minimum_delivery_charge_&_per_km_delivery_charge.')); ?>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="text-center mb-3">
                        <h3 class="modal-title mb-3"><?php echo e(translate('messages.New_Business_Zone_Created_Successfully!')); ?></h3>
                        <p class="txt">
                    ...
                    <div class="mt-3 d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <div class="btn--container justify-content-end">
                            <button id="reset_btn" type="reset" class="btn btn--reset" data-dismiss="modal"><?php echo e(translate('messages.I_Will_Do_It_Later')); ?></button>
                            <a href="<?php echo e(route('admin.zone.latest-settings')); ?>" class="btn btn--primary"><?php echo e(translate('messages.Go_to_Zone_Settings')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="<?php echo e(dynamicAsset('public/assets/admin/js/custom-drawing-manager.js')); ?>"></script>
<script>
    "use strict";
    ...
    $('#zone_form').on('submit', function () {
            ...
            $.post({
                url: '<?php echo e(route('admin.zone.store')); ?>',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                ...
                success: function (data) {
                    if(data.errors){
                        ...
                        lastpolygon.setMap(null);
                        $('#coordinates').val(null);
                        toastr.success("<?php echo e(translate('messages.New_Business_Zone_Created_Successfully!')); ?>", {
                                CloseButton: true,
                                ProgressBar: true
                            });
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zeeshan/Desktop/Desktop/Clients/Gizra/Gizra_full_backup_2026-08-19/deliverymain/resources/views/admin-views/zone/index.blade.php ENDPATH**/ ?>