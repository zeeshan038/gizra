...
Route::group(['namespace' => 'Vendor', 'as' => 'vendor.'], function () {
    Route::group(['middleware' => ['vendor' ,'maintenance']], function () {
        ...
        Route::group(['prefix' => 'listing-manager', 'as' => 'listing-manager.', 'middleware' => ['module:food', 'subscription:food']], function () {
            Route::get('/', 'FoodController@listingManager')->name('index');
            Route::get('items', 'FoodController@listingManagerGetItems')->name('items');
            Route::get('item/{id}', 'FoodController@listingManagerGetItem')->name('item');
            Route::post('store', 'FoodController@listingManagerStore')->name('store');
            Route::post('update/{id}', 'FoodController@listingManagerUpdate')->name('update');
            Route::delete('delete/{id}', 'FoodController@listingManagerDelete')->name('delete');
            Route::post('toggle-status', 'FoodController@listingManagerToggleStatus')->name('toggle-status');
            Route::get('get-categories', 'FoodController@listingManagerGetCategories')->name('get-categories');
            Route::post('ai-description', 'FoodController@listingManagerAiDescription')->name('ai-description');
            ...
            // Restaurant-specific category CRUD (ai-image before {id} to avoid capture)
            Route::get('categories', 'FoodController@listingManagerCategoryList')->name('categories');
            Route::post('categories', 'FoodController@listingManagerCategoryStore')->name('categories.store');
            Route::post('categories/ai-image', 'FoodController@listingManagerAiImageForCategory')->name('categories.ai-image');
            Route::post('categories/{id}', 'FoodController@listingManagerCategoryUpdate')->name('categories.update');
            Route::delete('categories/{id}', 'FoodController@listingManagerCategoryDelete')->name('categories.delete');
        });
