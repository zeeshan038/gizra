...
class OrderController extends Controller
{
    ...
    public function track_order(Request $request)
    {
        ...
        if($order){
            ...
            $order['accepted'] = $order['accepted'] ?: $order['confirmed'];
    ...
    public function place_order(Request $request)
    {
        ...
        // Suppress new-order buzzer for digital payment until payment is confirmed
    ...
    public function generate_payment_link(Request $request)
    {
        ...
        if (!$order) {
            return response()->json([
                'errors' => [['code' => 'order', 'message' => 'Order not found or already paid']]
            ], 404);
        }
        ...
        try {
            ...
            $payment_info = new PaymentInfo(
                ...
                payer_id: $user->id,
                receiver_id: $order->restaurant_id,
            ...
            $redirect_link = self::generate_link($payer, $payment_info, $receiver_info);

            return response()->json(['redirect_link' => $redirect_link], 200);

        } catch (\Exception $e) {
            return response()->json([
                'errors' => [['code' => 'payment', 'message' => $e->getMessage()]]
            ], 500);
        }
    }
}
