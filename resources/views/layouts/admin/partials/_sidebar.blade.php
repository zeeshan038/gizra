            ...
            <div class="navbar-vertical-content bg--title" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (Helpers::module_permission_check('order'))
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/order*') && !(Request::is('admin/order/manual*') || (isset($order) && $order->is_manual_dispatch == 1)) ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/order*') && (Request::is('admin/order/subscription*') == false && Request::is('admin/order/manual*') == false && Request::is('admin/order-cancel-reasons') == false && !(isset($order) && $order->is_manual_dispatch == 1)) ? 'block' : 'none' }}">
                                <li
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/order/manual*') || (isset($order) && $order->is_manual_dispatch == 1) ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.order.manual.list', ['status' => 'all']) }}"
                                title="{{ translate('Manual_Orders') }} ">
                                <i class="tio-bike nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{ translate('Manual_Orders') }}</span>
                            </a>
                        </li>
