...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::get('test-payment', 'DashboardController@testPayment')->name('testPayment');
        ...
        Route::group(['prefix' => 'partner-api-keys', 'as' => 'partner-api-keys.'], function () {
            Route::get('/', 'PartnerApiKeyController@index')->name('index');
            Route::post('/', 'PartnerApiKeyController@store')->name('store');
            Route::post('{partnerApiKey}/revoke', 'PartnerApiKeyController@revoke')->name('revoke');
            Route::post('webhooks', 'PartnerApiKeyController@storeWebhook')->name('webhooks.store');
            Route::post('webhooks/{webhook}/toggle', 'PartnerApiKeyController@toggleWebhook')->name('webhooks.toggle');
        });
        ...
        Route::group(['prefix' => 'banner', 'as' => 'banner.', 'middleware' => ['module:banner']], function () {
            ...
            Route::post('ai-image', 'BannerController@aiImage')->name('ai-image');
        ...
        Route::group(['prefix' => 'restaurant', 'as' => 'restaurant.','middleware'=>['module:restaurant']], function () {
            ...
            Route::get('get-account-data/{restaurant}', 'VendorController@get_account_data')->name('restaurant-account-data');
            ...
            Route::group(['middleware' => ['module:restaurant']], function () {
                ...
                // Admin listing manager — must come BEFORE the catch-all view/{restaurant}/{tab?} route
                Route::prefix('view/{rid}/listing-manager')->name('listing-manager.')->group(function () {
                    Route::get('/', 'AdminListingManagerController@index')->name('index');
                    Route::get('items', 'AdminListingManagerController@getItems')->name('items');
                    Route::get('item/{id}', 'AdminListingManagerController@getItem')->name('item');
                    Route::post('store', 'AdminListingManagerController@store')->name('store');
                    Route::post('update/{id}', 'AdminListingManagerController@update')->name('update');
                    Route::delete('delete/{id}', 'AdminListingManagerController@delete')->name('delete');
                    Route::post('toggle-status', 'AdminListingManagerController@toggleStatus')->name('toggle-status');
                    Route::get('get-categories', 'AdminListingManagerController@getCategories')->name('get-categories');
                    Route::post('ai-description', 'AdminListingManagerController@aiDescription')->name('ai-description');
                    Route::post('ai-image', 'AdminListingManagerController@aiImage')->name('ai-image');
                    Route::get('categories', 'AdminListingManagerController@categoryList')->name('categories');
                    Route::post('categories', 'AdminListingManagerController@categoryStore')->name('categories.store');
                    Route::post('categories/ai-image', 'AdminListingManagerController@categoryAiImage')->name('categories.ai-image');
                    Route::post('categories/{id}', 'AdminListingManagerController@categoryUpdate')->name('categories.update');
                    Route::delete('categories/{id}', 'AdminListingManagerController@categoryDelete')->name('categories.delete');
                });
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings', 'actch']], function () {
            ...
            Route::POST('landing-page-settings/{tab}', 'BusinessSettingsController@update_landing_page_settings')->name('landing-page-settings-post');
        ...
        Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.'], function () {
            ...
            Route::get('get-account-data/{deliveryman}', 'DeliveryManController@get_account_data')->name('deliveryman-account-data');
        ...
        Route::group(['middleware' => ['module:order']], function () {
            ...
            Route::group(['prefix' => 'order', 'as' => 'order.manual.'], function () {
                Route::get('manual/list/{status}', 'OrderController@manual_list')->name('list');
            });
