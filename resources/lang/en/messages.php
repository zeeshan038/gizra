<?php return array (
  ...
  'Delete this item? This cannot be undone.' => 'Delete this item? This cannot be undone.',
  'Failed to save' => 'Failed to save',
  'Saved successfully!' => 'Saved successfully!',
  'Item updated successfully' => 'Item updated successfully',
  'Saving…' => 'Saving…',
  'Each variation group must have at least one option' => 'Each variation group must have at least one option',
  'Variation group name is required' => 'Variation group name is required',
  'Price is required when no variations are set' => 'Price is required when no variations are set',
  'Available Until must be after Available From' => 'Available Until must be after Available From',
  'Availability time is required' => 'Availability time is required',
  'Category is required' => 'Category is required',
  'Item stock is required for limited/daily stock type' => 'Item stock is required for limited/daily stock type',
  ...
  'e.g. Size, Toppings' => 'E.g. Size, Toppings',
  ...
  'AI Image' => 'AI Image',
  'AI image generation failed' => 'AI image generation failed',
  'for AI description & image generation in Listing Manager' => 'For AI description & image generation in Listing Manager',
  'Gemini API Key' => 'Gemini API Key',
  'Enable AI Feature' => 'Enable AI Feature',
  'Gen…' => 'Gen…',
  'AI generation failed' => 'AI generation failed',
  'Google Gemini AI Setup' => 'Google Gemini AI Setup',
  'Enter item name first to generate AI content' => 'Enter item name first to generate AI content',
  'Failed to load items' => 'Failed to load items',
  'All Items' => 'All Items',
  'Live preview updates automatically' => 'Live preview updates automatically',
  'This is how customers will see it in the app.' => 'This is how customers will see it in the app.',
  'Gemini key (AIzaSy...) or HuggingFace token (hf_...) — both work for description & image generation' => 'Gemini key (AIzaSy...) or HuggingFace token (hf ...) — both work for description & image generation',
  'AI API Key' => 'AI API Key',
  'Add Variation Group' => 'Add Variation Group',
  'Create variation groups (e.g. Size, Toppings). When variations exist, the base price is set from the first option automatically.' => 'Create variation groups (e.g. Size, Toppings). When variations exist, the base price is set from the first option automatically.',
  'Non-Veg' => 'Non-Veg',
  'Available Until' => 'Available Until',
  'This_point_marks_the_longitude_of_the_restaurants_location_on_the_map' => 'This point marks the longitude of the restaurants location on the map',
  ...
  'AI image failed' => 'AI image failed',
  'Enter category name first' => 'Enter category name first',
  'Select category' => 'Select category',
  'Disabled' => 'Disabled',
  ...
  'Price set automatically from first variation option' => 'Price set automatically from first variation option',
  'This_point_marks_the_latitude_of_the_restaurants_location_on_the_map.' => 'This point marks the latitude of the restaurants location on the map.',
  'Sub Category' => 'Sub Category',
  'Short description…' => 'Short description…',
  'AI Write' => 'AI Write',
  'Generate description with AI' => 'Generate description with AI',
  'Item name' => 'Item name',
  'Click AI Image to auto-generate a food photo, or AI below description to write it.' => 'Click AI Image to auto-generate a food photo, or AI below description to write it.',
  'Get free key at aistudio.google.com/apikey — format: AIzaSy...' => 'Get free key at aistudio.google.com/apikey — format: AIzaSy...',
  'hypay' => 'Hypay',
  ...
  'Generate image with AI' => 'Generate image with AI',
  'Upload' => 'Upload',
  'Preview' => 'Preview',
  ...
  'All changes logged.' => 'All changes logged.',
  'Failed_to_send_mail' => 'Failed to send mail',
  ...
  'Gemini is reading your menu and generating images... Please wait (this can take up to a minute).' => 'Gemini is reading your menu and generating images... Please wait (this can take up to a minute).',
  'Loading...' => 'Loading...',
  'Upload a PDF or clear image of your menu. The Gemini AI will extract categories, items, prices, descriptions, and option variations automatically, then generate high-quality food photos using AI.' => 'Upload a PDF or clear image of your menu. The Gemini AI will extract categories, items, prices, descriptions, and option variations automatically, then generate high-quality food photos using AI.',
  'Upload Menu PDF or Image' => 'Upload Menu PDF or Image',
  'AI-Powered Menu Import' => 'AI-Powered Menu Import',
  'Download Template' => 'Download Template',
  'CSV Format:' => 'CSV Format:',
  'Manual_Orders' => 'Manual Orders',
  'Manual Orders' => 'Manual Orders',
  'failed_to_assign_deliveryman' => 'Failed to assign deliveryman',
  'deliveryman_assigned_successfully' => 'Deliveryman assigned successfully',
  'Upload CSV File' => 'Upload CSV File',
  'Import Menu via CSV' => 'Import Menu via CSV',
  'Approve & Publish' => 'Approve & Publish',
  'Approve failed' => 'Approve failed',
  'Address:' => 'Address:',
  'You want to assign this deliveryman?' => 'You want to assign this deliveryman?',
  'No active drivers online in this zone.' => 'No active drivers online in this zone.',
  'Approving…' => 'Approving…',
  'Bulk publish failed' => 'Bulk publish failed',
  'No items selected' => 'No items selected',
  'Auto-assigned: A request was sent to all active delivery men in zone:' => 'Auto-assigned: A request was sent to all active delivery men in zone:',
  'Scanning PDF Menu...' => 'Scanning PDF Menu...',
  'Upload a PDF or clear image of your menu. Gemini AI will scan it, extract categories, items, prices, and variations, and load them into drafts.' => 'Upload a PDF or clear image of your menu. Gemini AI will scan it, extract categories, items, prices, and variations, and load them into drafts.',
  ...
  'Import by PDF/Image (AI)' => 'Import by PDF/Image (AI)',
  'Publish Selected' => 'Publish Selected',
  'Draft' => 'Draft',
  'Publish' => 'Publish',
  'Gemini AI Scanning PDF Menu...' => 'Gemini AI Scanning PDF Menu...',
  'Reading CSV file...' => 'Reading CSV file...',
  'Parsing items and categories...' => 'Parsing items and categories...',
  'No items parsed from file.' => 'No items parsed from file.',
