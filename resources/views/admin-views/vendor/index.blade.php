            ...
            <div class="row g-2">
                            ...
                            <div class="lang_form" id="default-form">
                                ...
                                <div class="d-none lang_form" id="{{$lang}}-form">
                                    ...
                                    <div>
                                        ...
                                        <textarea id="address{{$lang}}" name="address[]" class="form-control h-70px" placeholder="{{ translate('messages.Ex:_House#94,_Road#8,_Abc_City') }} "  ></textarea>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="latitude">{{ translate('messages.latitude') }}<span data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('messages.This_point_marks_the_latitude_of_the_restaurants_location_on_the_map.') }}"
                                                class="input-label-secondary"><img
                                                    src="{{ dynamicAsset('/public/assets/admin/img/info-circle.svg') }}"
                                    ...
                                    <div class="form-group mb-md-0">
                                        <label class="input-label" for="longitude">{{ translate('messages.longitude') }}
                                                <span data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('messages.This_point_marks_the_longitude_of_the_restaurants_location_on_the_map') }}"
                                                class="input-label-secondary"><img
                                                    src="{{ dynamicAsset('/public/assets/admin/img/info-circle.svg') }}"
                                                    alt="{{ translate('messages.restaurant_lat_lng_warning') }}"></span>
                                                </label>
                ...
                @endif
                    ...
                    {{-- <div class="col-lg-12" >
                        ...
                        <select name="tags" class="form-control multiple-select2"  data-placeholder="{{ translate('messages.Type your content and  press enter') }}" multiple>
                        </select>
                    </div> --}}
        ...
        $(function() {
            $("#coba").spartanMultiImagePicker({
                ...
                function placeMarker(lat, lng) {
                    ...
                    if (currentMarker) {
                        ...
                        currentMarker.addListener('dragend', function () {
                            const p = currentMarker.getPosition();
                ...
                $('#choice_zones').on('change', function() {
                    ...
                    document.getElementById('latitude').addEventListener('change', syncMapFromFields);
                    document.getElementById('longitude').addEventListener('change', syncMapFromFields);
