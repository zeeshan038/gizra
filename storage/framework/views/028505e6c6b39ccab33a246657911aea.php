...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(dynamicAsset('public/assets/admin/css/custom.css')); ?>">
    <!-- CSS Front Template -->
    ...
    <link rel="stylesheet" href="<?php echo e(dynamicAsset('public/assets/admin/css/emojionearea.min.css')); ?>">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div  class="text-center">
                                    ...
                                    <hr>
                                    <button class="btn btn-primary check-order"><?php echo e(translate('messages.Ok_let_me_check')); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="text-center">
                                    ...
                                    <hr>
                                    <button
                                        class="btn btn-primary check-message"><?php echo e(translate('messages.Ok_let_me_check')); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
...
"use strict";
    ...
    <script>
        ...
        function conversationList() {
            ...
            console.log(tab)
            $.ajax({
                    url: "<?php echo e(route('admin.message.list')); ?>"+ '?tab=' + tab,
    ...
    <?php ($order_notification_type = $order_notification_type ? $order_notification_type->value : 'firebase'); ?>
        ...
        $(document).on('click', '.check-message', function () {
            var tab = getUrlParameter('tab');
            location.href = '<?php echo e(route('admin.message.list')); ?>'+ '?tab=' + tab;
        });

        if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write(
            '<script src="<?php echo e(dynamicAsset('public/assets/admin')); ?>/vendor/babel-polyfill/polyfill.min.js"><\/script>');
...
<?php /**PATH /Users/zeeshan/Desktop/Desktop/Clients/Gizra/Gizra_full_backup_2026-08-19/deliverymain/resources/views/layouts/admin/app.blade.php ENDPATH**/ ?>