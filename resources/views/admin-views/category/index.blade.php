                        ...
                        <tr>
                            ...
                            <td>
                                @if($category->restaurant_id)
                                    <span class="badge badge-soft-primary font-size-10">
                                        {{ optional(\App\Models\Restaurant::find($category->restaurant_id))->name ?? '#'.$category->restaurant_id }}
                                    </span>
                                @else
                                    <span class="text-muted font-size-10">{{ translate('messages.global') }}</span>
                                @endif
                            </td>
                            <td>
