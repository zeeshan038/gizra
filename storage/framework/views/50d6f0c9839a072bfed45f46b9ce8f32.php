<!doctype html>
<html lang="en" data-theme="<?php echo e($config->renderer()->get('theme', 'light')); ?>">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="color-scheme" content="<?php echo e($config->renderer()->get('theme', 'light')); ?>">
    ...
    <?php echo $__env->make('scramble::dev-tools', ['renderer' => 'elements'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<elements-api
    id="docs"
    <?php $__currentLoopData = $config->renderer()->all(except: ['theme']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(! $value) continue; ?>
        <?php echo e($key); ?>="<?php echo e($value === true ? 'true' : ($value === false ? 'false' : $value)); ?>"
...
<?php if($config->renderer()->get('theme', 'light') === 'system'): ?>
    <script>
...
<?php /**PATH /Users/zeeshan/Desktop/Desktop/Clients/Gizra/Gizra_full_backup_2026-08-19/deliverymain/vendor/dedoc/scramble/resources/views/docs.blade.php ENDPATH**/ ?>