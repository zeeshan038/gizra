...
class DeliverymanController extends Controller
{
    ...
    public function update_order_status(Request $request)
    {
        ...
        // OTP verification on delivery is disabled for the deliveryman app — courier
        // can mark an order delivered without entering the customer's OTP. Left
        // untouched everywhere else (customer app, vendor app, admin panel).
        ...
        // OTP match check removed for deliveryman app (see note above).
