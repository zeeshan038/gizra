                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="cmn--media dropdown-toggle d-flex align-items-center">
                                    <div class="avatar avatar-sm avatar-circle">
                                            ...
                                            src="<?php echo e(auth('admin')?->user()?->image_full_url); ?>"
                                            alt="image">
                                ...
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center">
                                        <div class="avatar avatar-sm avatar-circle mr-2">
                                            <img class="avatar-img"
                                            src="<?php echo e(auth('admin')?->user()?->image_full_url ?? dynamicAsset('public/assets/admin/img/160x160/img1.jpg')); ?>"
                                            alt="image">
                                        </div>
...
<?php /**PATH /Users/zeeshan/Desktop/Desktop/Clients/Gizra/Gizra_full_backup_2026-08-19/deliverymain/resources/views/layouts/admin/partials/_header.blade.php ENDPATH**/ ?>