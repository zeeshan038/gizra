...
//        file_put_contents(base_path('.env'), implode(PHP_EOL, $lines) . PHP_EOL);
    ...
    public function payment_index()
    {
        ...
        ->whereIn('key_name', ['ssl_commerz','paypal','stripe','razor_pay','senang_pay','paytabs','paystack',
        'paymob_accept','paytm','flutterwave','liqpay','bkash','mercadopago','hyper_pay'])->get();
    ...
    public function payment_config_update(Request $request)
    {
        ...
        $validation = [
            'gateway' => 'required|in:ssl_commerz,paypal,stripe,razor_pay,senang_pay,paytabs,paystack,paymob_accept,paytm,flutterwave,liqpay,bkash,mercadopago,hyper_pay',
...
//
    ...
    public function config_update(Request $request)
    {
        ...
        Helpers::businessUpdateOrInsert(['key' => 'gemini_api_key'], [
            'value' => $request['gemini_api_key'] ?? ''
        ]);

        Helpers::businessUpdateOrInsert(['key' => 'gemini_ai_enabled'], [
            'value' => $request->input('gemini_ai_enabled') == '1' ? '1' : '0'
        ]);
