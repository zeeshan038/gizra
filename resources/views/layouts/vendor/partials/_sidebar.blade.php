        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content text-capitalize bg-334257">
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle">{{translate('Listing Manager')}}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    @if(\App\CentralLogics\Helpers::employee_module_permission_check('food'))
                    <li class="nav-item {{Request::is('restaurant-panel/listing-manager*')?'active':''}}">
                        <a class="nav-link" href="{{route('vendor.listing-manager.index')}}" title="{{translate('Listing Manager')}}">
                            <i class="tio-layers-outlined nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Listing Manager')}}</span>
                        </a>
                    </li>
                    @endif
