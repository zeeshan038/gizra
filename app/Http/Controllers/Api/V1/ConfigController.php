...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        $key = [
            ...
            'map_api_key', 'map_api_key_server',
        ];
        ...
        return response()->json([
            ...
            'map_api_key' => isset($settings['map_api_key']) ? $settings['map_api_key'] : null,
            'map_api_key_server' => isset($settings['map_api_key_server']) ? $settings['map_api_key_server'] : null,
    ...
    private function getDefaultPaymentMethods()
    {
        ...
        ['ssl_commerz','paypal','stripe','razor_pay','senang_pay','paytabs','paystack','paymob_accept','paytm','flutterwave','liqpay','bkash','mercadopago'])->get();
        $env = env('APP_ENV') == 'live' ? 'live' : 'test';
        $credentials = $env . '_values';
